%function PIVlab_plot_sync_timing_table(timing_table)
disp('lezzgo')
...
timing_table=  table(frame_time,ch1_up1,ch1_dn1,'RowNames',['frame_time','ch1','ch2'])
...
%{
function straddling_graph_oltSync(blind_time,frame_rate,pulse_distance,laser_energy,num_exposures_to_show,is_dbl_shutter,f1exp_cam)
